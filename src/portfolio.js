...
const seo = {
  title: "Terima Kasih dari Kelas 4-02",
  description: "Kepada Bapak Sindhu Wardhana",
  og: {
    title: "Kepada Bapak Sindhu Wardhana",
    type: "website",
    url: "",
  },
};
...
const skills = {
  data: [
    {
      title: "Pak Sindhu Wardhana",
      fileName: "DataScienceImg",
      skills: [
        "⚡ First Impressionnya Lucu",
        "⚡ Proses pembelajaran santai tapi serius",
        "⚡ Tugas-tugas cukup ringan",
        "⚡ Dosen yang sabar dan Seru!",
        "⚡ Walau Sibuk Tetap Menerangkan",
        "⚡ Pengertian sama mahasiswa",
        "⚡ Apa itu Quiz?",
      ],
      softwareSkills: [
        {
